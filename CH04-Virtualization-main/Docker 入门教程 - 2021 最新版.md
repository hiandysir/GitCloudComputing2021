2021年4月2日/[#DOCKER](https://chinese.freecodecamp.org/news/tag/docker/)
...
此外，如果你想了解容器的历史，可以阅读 [A Brief History of Containers: From the 1970s Till Now](https://blog.aquasec.com/a-brief-history-of-containers-from-1970s-chroot-to-docker-2016)，它描述了该技术的很多重要节点。
...
![img](https://www.freecodecamp.org/news/content/images/2021/01/hello-dock-dev.png)
...
![img](https://www.freecodecamp.org/news/content/images/2021/01/local-vs-container-file-system.svg)

要解决此问题，可以再次使用 [绑定挂载](https://docs.docker.com/storage/bind-mounts/)。 使用绑定挂载，可以轻松地在容器内安装本地文件系统目录。绑定挂载可以直接从容器内部引用本地文件系统，而无需复制本地文件。

![img](https://www.freecodecamp.org/news/content/images/2021/01/bind-mounts.svg)
...
- `DB_PASSWORD` - 连接数据库的密码。 这也在运行数据库服务小节涉及，使用环境变量`POSTGRES_PASSWORD`。
...
![img](https://www.freecodecamp.org/news/content/images/2021/01/bonjour-mon-ami.png)

该 API 总共有五个路由，可以在 `/notes/api/api/api/routes/notes.js` 文件中看到。 它是用我的一个[开源项目](https://github.com/fhsinchy/create-node-rocket-api)引导的。
...
![img](https://www.freecodecamp.org/news/content/images/2021/01/fullstack-application-design.svg)
...
![img](https://www.freecodecamp.org/news/content/images/2021/01/notes-application.png)
...
可以在 Twitter [@frhnhsin](https://twitter.com/frhnhsin) 上关注我，也可以在 LinkedIn [/in/farhanhasin](https://www.linkedin.com/in/farhanhasin/) 联系我。

原文：[The Docker Handbook – 2021 Edition](https://www.freecodecamp.org/news/the-docker-handbook/#how-to-install-docker)，作者：[Farhan Hasin Chowdhury](https://www.freecodecamp.org/news/author/farhanhasin/)